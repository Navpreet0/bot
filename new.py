...
bot = telebot.TeleBot('7815042837:AAHpZIsca7TBQIt8JsqWyVmz8oHlOSbwE8w')

# Admin user IDs
admin_id = ["5099926726,1332360551"]
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 0:
                response = "You Are On Cooldown ❌. Please Wait a sec Before Running The /bgmi Command Again."
                bot.reply_to(message, response)
                return
        ...
        response = ("😈 Unauthorized Access! 😈\n\nOops! It seems like you don't have permission to use the /bgmi command.                                                                          DM TO BUY ACCESS:- @Jaat0456")
